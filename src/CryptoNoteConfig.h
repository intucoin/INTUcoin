...
const uint64_t GENESIS_BLOCK_REWARD                          = UINT64_C(20000000000);
...
const int      P2P_DEFAULT_PORT                              =  31569;
const int      RPC_DEFAULT_PORT                              =  31570;
...
const std::initializer_list<CheckpointData> CHECKPOINTS = { 
  ...
  {300165, "be981379ba037d528ae3055ccea5018b86b755438ab7c50477a28caa0533f8b2" }
 };
} // CryptoNote
